    ...
    <footer className="border-t border-line bg-surface/40">
      <div className="container-page grid gap-10 py-14 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-4 max-w-sm text-sm leading-relaxed text-muted">
            A high-end B2C storefront and distributed inventory platform —
            flexible pricing, smart logistics and precise order fulfilment, from
            the central warehouse to every boutique.
          </p>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5 text-sm">
            <li>
              <Link
                to="/catalog"
                className="text-content/80 transition-colors hover:text-primary"
              >
                Catalog
              </Link>
            </li>
      ...
      <div className="border-t border-line">
        <div className="container-page flex flex-col items-center justify-between gap-2 py-5 text-xs text-muted sm:flex-row">
          <p>
            © {new Date().getFullYear()} Al Amine Management System. All rights
            reserved.
          </p>
          <p className="font-mono uppercase tracking-[0.15em]">
            Al Amine · Management Suite
          </p>
        </div>
      </div>
    </footer>
