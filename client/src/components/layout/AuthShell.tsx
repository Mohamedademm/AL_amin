...
// Two-pane auth layout: magenta brand panel + the form on the right.
export default function AuthShell({
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      {/* Brand panel */}
      <div className="relative hidden flex-col justify-between overflow-hidden bg-gradient-to-br from-[#7a2269] via-[#972c83] to-[#4a1440] p-12 text-white lg:flex">
        ...
        <Link to="/" className="relative">
          <span className="flex items-center gap-3">
            <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/15 backdrop-blur p-1">
              <img
                src="/logo.png"
                alt="Al Amine"
        ...
        <div className="relative">
          <h2 className="font-serif text-4xl font-bold leading-tight">
            Operational control, from warehouse to boutique.
          </h2>
