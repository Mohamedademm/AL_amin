        ...
        {refused ? (
          <div className="flex items-center gap-3 text-red-500">
            ...
            <p className="font-medium">
              This order was{" "}
              {order.status === "REFUSED" ? "cancelled / refused" : "closed"}.
            </p>
          </div>
        ) : (
        ...
        <div className="space-y-3 lg:col-span-2">
          ...
          <div className="rounded-2xl border border-line bg-surface p-5">
            <h2 className="flex items-center gap-2 text-lg font-semibold">
              <MapPin size={18} className="text-primary" /> Delivery
            </h2>
            <div className="mt-3 space-y-2 text-sm text-muted">
              <p className="flex items-center gap-2">
                <Store size={15} /> {order.spot?.name ?? "Boutique"}
              </p>
              <p className="flex items-center gap-2">
              ...
              >
                ...
                <div className="text-sm">
                  ...
                  <p className="text-muted">
                    {order.fulfilment === "LOCAL"
                      ? "Shipped from the nearest boutique — immediate delivery"
                      : `From the central warehouse — est. ${order.etaDays ?? 2} days`}
                  </p>
                </div>
              </div>
            )}
